...
<form method="post" action="">
	...
	<p>
		<input type="submit"  class="btn btn-lg btn-success offset-md-2" value=" Enter ">
	</p>
...
if ($img<6) {
	...
	$view='hangman6.png';
	//session_destroy();
	echo "<p class='offset-md-1 col-md-10 font-weight-bold bg-light text-danger'> Game over </p>";
	echo "<p class='btn btn-lg btn-success offset-md-1 font-weight-bold'><a href='hangman.php'> Select a new word. </a></p>";
}
echo " <img src= '". $view . "' >";
...
$select_user = "SELECT * FROM users WHERE user_name ='$user_name'";
	...
	$user_game=$user['user_game'];
		...
		if ($_SESSION['result']==count($wordArray)) {
			echo "<p> Congratulations! You earn a point :) </p>";
			echo "<p><a href='hangman.php'> Select a new word. </a></p>";
			$user_score++;
			//echo $user_score;
			$user_game++;
			//echo $user_game;
